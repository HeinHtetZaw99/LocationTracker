 ...
 */
class Step7Fragment : BaseStepFragment<SelfExaminationActivity>() {
    ...
    override var fragmentLayout: Int = R.layout.fragment_step7


    override fun saveData() {
        parentActivity.data.havingAnyCOVIDPatientInVincinitySelection =
